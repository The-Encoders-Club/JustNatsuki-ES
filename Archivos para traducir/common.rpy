# TODO: Translation updated at 2025-06-05 1:17 AM UTC

translate spanish strings:

    # renpy/common/00accessibility.rpy:28
    old "Self-voicing disabled."
    new "Auto narración desactivada"

    # renpy/common/00accessibility.rpy:29
    old "Clipboard voicing enabled. "
    new "Narración del portapapeles activada "

    # renpy/common/00accessibility.rpy:30
    old "Self-voicing enabled. "
    new "Auto-narración activada "
    ...
    new "Escalado del tamaño de texto"
    ...
    new "El soporte de auto narración es limitado al usar una pantalla táctil"
    ...
    new "Reducción de volumen de auto narración"

    # renpy/common/00accessibility.rpy:237
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "Las opciones de este menú están destinadas a mejorar la accesibilidad. Pueden no funcionar con todos los juegos, y algunas combinaciones de opciones pueden hacer el juego injugable. Esto no es un problema del juego o el motor. Para mejores resultados al cambiar las fuentes, trata de mantener el tamaño de texto igual al original."
    ...
    old "File page auto"
    new "Archivo de páginas automático"
    ...
    new "Página anterior de archivos"
    ...
    new "Clic para alternar atributo, clic derecho para alternar atributo negativo."
    ...
    new "Clic para establecer transformación, clic derecho para agregar a la lista de transformaciones."
    ...
    new "Clic para establecer, clic derecho para agregar a la lista detrás."
    ...
    new "Personaliza director.audio_channels para agregar más canales."
    ...
    new "¿Estás seguro de que quieres empezar a omitir contenido?"

    # renpy/common/00gui.rpy:457
    old "Are you sure you want to skip to the next choice?"
    new "¿Estás seguro de que quieres pasar a la siguiente elección?"

    # renpy/common/00gui.rpy:458
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "¿Estás seguro de que quieres omitir el diálogo no visto hasta la siguiente elección?"
    ...
    new "¿Confías en el dispositivo donde se creó la partida guardada? Solo deberías elegir aceptar si eres el único usuario del dispositivo."

    # renpy/common/00keymap.rpy:325
    old "Failed to save screenshot as %s."
    new "Error al guardar captura de pantalla como %s."
    ...
    new "Este programa contiene software libre bajo varias licencias, incluyendo la Licencia MIT y la Licencia Pública General Menor de GNU. Una lista completa del software, incluyendo enlaces al código fuente completo, se puede encontrar {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    new "omitir después de elecciones"
    ...
    new "avance automático después de clic"
    ...
    new "activar auto narración"

    # renpy/common/00preferences.rpy:442
    old "self voicing disable"
    new "desactivar auto narración"

    # renpy/common/00preferences.rpy:446
    old "self voicing volume drop"
    new "reducción de volumen de la auto narración"

    # renpy/common/00preferences.rpy:454
    old "clipboard voicing"
    new "narración del portapapeles"
    ...
    old "debug voicing"
    new "depurar narración"

    # renpy/common/00preferences.rpy:466
    old "debug voicing enable"
    new "activar la depuración de la narración"

    # renpy/common/00preferences.rpy:468
    old "debug voicing disable"
    new "desactivar la depuración de la narración"
    ...
    new "restaurar posición de ventana"
    ...
    new "Narración del portapapeles activada. Presiona 'shift+C' para desactivarla."

    # renpy/common/00preferences.rpy:703
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "La auto-narración diría \"[renpy.display.tts.last]\". Presiona 'alt+shift+V' para desactivarla."

    # renpy/common/00preferences.rpy:705
    old "Self-voicing enabled. Press 'v' to disable."
    new "Auto-narración activada. Presiona 'v' para desactivarla."

    # renpy/common/00speechbubble.rpy:416
    old "Speech Bubble Editor"
    new "Editor de burbujas de diálogo"
    ...
    new "(limpiar burbujas retenidas)"
    ...
    new "El servidor de Ren'Py Sync agotó el tiempo de espera."

    # renpy/common/00sync.rpy:197
    old "An unknown error occurred while connecting to the Ren'Py Sync server."
    new "Ocurrió un error desconocido al conectar con el servidor de Ren'Py Sync."

    # renpy/common/00sync.rpy:213
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "El servidor de Ren'Py Sync no tiene una copia de esta sincronización. El ID de sincronización puede ser inválido, o puede haber expirado."

    # renpy/common/00sync.rpy:316
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Por favor ingresa el ID de sincronización que generaste.\nNunca ingreses un ID de sincronización que no hayas creado tú mismo."

    # renpy/common/00sync.rpy:335
    old "The sync ID is not in the correct format."
    new "El ID de sincronización no está en el formato correcto."

    # renpy/common/00sync.rpy:355
    old "The sync could not be decrypted."
    new "La sincronización no se pudo descifrar."
    ...
    new "La sincronización contiene un archivo con un nombre inválido."
    ...
    new "Esto contactará al {a=https://sync.renpy.org}Servidor de Ren'Py Sync{/a}."
    ...
    new "Puedes usar este ID para descargar tu partida en otro dispositivo.\nEsta sincronización expirará en una hora.\nRen'Py Sync es respaldado por {a=https://www.renpy.org/sponsors.html}los Patrocinadores de Ren'Py{/a}."
    ...
    new "Este proyecto no soporta actualizaciones, o el archivo de estado de actualización fue eliminado."

    # renpy/common/00updater.rpy:967
    old "This account does not have permission to perform an update."
    new "Esta cuenta no tiene permisos para realizar una actualización."

    # renpy/common/00updater.rpy:970
    old "This account does not have permission to write the update log."
    new "Esta cuenta no tiene permisos para escribir el registro de actualización."
    ...
    new "El archivo de actualización no fue descargado."

    # renpy/common/00updater.rpy:1391
    old "The update file does not have the correct digest - it may have been corrupted."
    new "El archivo de actualización no tiene el resumen correcto - puede haber sido corrompido."
    ...
    new "Verificando actualizaciones."
    ...
    new "Este juego no puede ejecutarse hasta que los datos del juego hayan sido descargados."
    ...
    new "Los cambios tomarán efecto la próxima vez que se ejecute este programa."
    ...
    new "Esta computadora tiene un problema mostrando gráficos: [problem]."

    # renpy/common/00gltest.rpy:257
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Sus controladores gráficos pueden estar desactualizados o no funcionar correctamente. Esto puede llevar a una visualización gráfica lenta o incorrecta."
    ...
    new "Más detalles sobre cómo arreglar esto se pueden encontrar en la {a=[url]}documentación{/a}."
    ...
    new "Continuar, no mostrar advertencia de nuevo"
    ...
    new "Seleccionar mando para calibrar"
    ...
    new "Intenta retroceder a un momento anterior, permitiéndote guardar o elegir una opción diferente."
    ...
    new "Ignora la excepción, permitiéndote continuar. Esto a menudo lleva a errores adicionales."
